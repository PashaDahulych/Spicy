! function(t, e) {
    ...
    var p = function(i) {
        ...
        for (t in f = nt.support = {}, s = nt.isXML = function(t) {
                ...
                return n !== T && 9 === n.nodeType && n.documentElement && (r = (T = n).documentElement, S = !s(T), (i = T.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", it, !1) : i.attachEvent && i.attachEvent("onunload", it)), f.attributes = rt(function(t) {
                    ...
                    f.disconnectedMatch = d.call(t, "div"), d.call(t, "[s!='']:x"), a.push("!=", z)
    ...
    C.extend({
        hasData: function(t) {
            return j.hasData(t) || N.hasData(t)
        },
        data: function(t, e, i) {
        ...
        data: function(n, t) {
            var e, i, s, o = this[0],
                r = o && o.attributes;
            if (void 0 === n) {
                if (this.length && (s = j.get(o), 1 === o.nodeType && !N.get(o, "hasDataAttrs"))) {
            ...
            return "object" == typeof n ? this.each(function() {
                ...
                var t, i;
                if (o && void 0 === e) {
                    if (void 0 !== (t = j.get(o, n) || j.get(o, n.replace(R, "-$&").toLowerCase()))) return t;
                    if (i = C.camelCase(n), void 0 !== (t = j.get(o, i))) return t;
    ...
    function Rt(t, e, i) {
        ...
        return s + zt(t, e, i || (r ? "border" : "content"), n, o) + "px"
    }
    ...
    C.extend({
        ...
        C.cssHooks[r] = {
            ...
            set: function(t, e, i) {
                var n, s = i && _t(t),
                    o = i && zt(t, r, i, "border-box" === C.css(t, "boxSizing", !1, s), s);
                return o && (n = W.exec(e)) && "px" !== (n[3] || "px") && (t.style[r] = e, e = C.css(t, r)), jt(0, e, o)
            }
        }
        ...
        }, Ct.test(s) || (C.cssHooks[s + o].set = jt)
    }), C.fn.extend({
        css: function(t, e) {
        ...
        S.mask = {
            ...
            mask: function(e, v) {
                ...
                return v = S.extend({
                    ...
                    completed: null
                }, v), i = S.mask.definitions, y = [], w = k = e.length, b = null, S.each(e.split(""), function(t, e) {
                    "?" == e ? (k--, w = t) : i[e] ? (y.push(new RegExp(i[e])), null === b && (b = y.length - 1), t < w && (x = y.length - 1)) : y.push(null)
                    ...
                    function c(t, e) {
                        ...
                        if (!(t < 0)) {
                            for (i = t, n = l(e); i < k; i++)
                                if (y[i]) {
                                    if (!(n < k && y[i].test(f[n]))) break;
                                    f[i] = f[n], f[n] = a(n), n = l(n)
                                } u(), p.caret(Math.max(b, t))
                        }
                    }
                    ...
                    function h(t) {
                        ...
                        for (n = e = 0; e < k; e++)
                            ...
                            } else f[e] === s.charAt(n) && n++, e < w && (o = e);
                        return t ? u() : o + 1 < w ? v.autoclear || f.join("") === m ? (p.val() && p.val(""), d(0, k)) : u() : (u(), p.val(p.val().substring(0, o + 1))), w ? e : b
                    }
                    var p = S(this),
                    ...
                    p.data(S.mask.dataName, function() {
                        ...
                        var t;
                        p.prop("readonly") || (clearTimeout(n), g = p.val(), t = h(), n = setTimeout(function() {
                            p.get(0) === document.activeElement && (u(), t == e.replace("?", "").length ? p.caret(0, t) : p.caret(t))
                        }, 10))
                    }).on("blur.mask", o).on("keydown.mask", function(t) {
                        if (!p.prop("readonly")) {
                            var e, i, n, s = t.which || t.keyCode;
                            T = p.val(), 8 === s || 46 === s || C && 127 === s ? (i = (e = p.caret()).begin, (n = e.end) - i == 0 && (i = 46 !== s ? function(t) {
                                for (; 0 <= --t && !y[t];);
                                return t
                            }(i) : n = l(i - 1), n = 46 === s ? l(n) : n), d(i, n), c(i, n - 1), t.preventDefault()) : 13 === s ? o.call(this, t) : 27 === s && (p.val(g), p.caret(0, h()), t.preventDefault())
                        }
                    }).on("keypress.mask", function(t) {
                        if (!p.prop("readonly")) {
                            var e, i, n, s = t.which || t.keyCode,
                                o = p.caret();
                            t.ctrlKey || t.altKey || t.metaKey || s < 32 || !s || 13 === s || (o.end - o.begin != 0 && (d(o.begin, o.end), c(o.begin, o.end - 1)), (e = l(o.begin - 1)) < k && (i = String.fromCharCode(s), y[e].test(i)) && (function(t) {
                                var e, i, n, s;
                                for (i = a(e = t); e < k; e++)
                                    if (y[e]) {
                                        if (n = l(e), s = f[e], f[e] = i, !(n < k && y[n].test(s))) break;
                                        i = s
                                    }
                            }(e), f[e] = i, u(), n = l(e), $ ? setTimeout(function() {
                                S.proxy(S.fn.caret, p, n)()
                            }, 0) : p.caret(n), o.begin <= x && r()), t.preventDefault())
                        }
                    ...
                    }), s && $ && p.off("input.mask").on("input.mask", function() {
                        var t = p.val(),
                            e = p.caret();
                        if (T && T.length && T.length > t.length) {
                            for (h(!0); 0 < e.begin && !y[e.begin - 1];) e.begin--;
                            if (0 === e.begin)
                                for (; e.begin < b && !y[e.begin];) e.begin++;
                            p.caret(e.begin, e.begin)
                        } else {
                            for (h(!0); e.begin < k && !y[e.begin];) e.begin++;
                            p.caret(e.begin, e.begin)
                        }
                        r()
                    }), h()
...
$(document).ready(function() {
    $('input[data-field-name="phone"]').mask("+38 (999) 999-9999")
});
...
var reservation = function() {
    ...
    choice = function() {
        ...
        ! function() {
            ...
            var n = e.text();
            i.find("input").val(n).trigger("change"), e.closest(".choice__item").addClass(s), o(i)
...
var app = {
    init: function() {
        $("[data-bg-src]").each(function() {
            var t = $(this).data("bg-src"),
                e = t.substring(0, 3);
            "/en" !== e && "/ru" !== e && "/ua" !== e || (t = t.replace(/^.{3}/, ""), $(this).attr("data-bg-src", t))
        }), $(".nav__fake").each(function() {
            var t = $(this).css("background-image"),
                e = t.indexOf("/en"),
                i = t.indexOf("/ru"),
                n = t.indexOf("/ua");
            0 <= e && (t = t.replace("/en", ""), $(this).css("background-image", t)), 0 <= i && (t = t.replace("/ru", ""), $(this).css("background-image", t)), 0 <= n && (t = t.replace("/ua", ""), $(this).css("background-image", t))
